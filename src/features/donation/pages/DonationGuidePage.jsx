...
const steps = [
  ...
  {
    title: "기부 방식 선택",
    description: "일시 후원 방식과 결제 정보를 확인하고, 나에게 맞는 흐름으로 참여합니다.",
    icon: CreditCard,
  },
  {
    title: "기록 확인",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <section className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg text-stone-500 leading-relaxed">
            이 사이트에서 어디를 먼저 보면 좋은지, 어떤 정보를 확인하면 좋은지, 후원 뒤에는 무엇을 체크하면 되는지 한 번에 볼 수 있게 정리했습니다.
          </p>
        </section>
        ...
        <section className="mt-20 grid lg:grid-cols-2 gap-10">
          <div className="bg-white border-4 border-line rounded-[3rem] p-10">
            ...
            <ul className="space-y-4 text-stone-600 font-medium">
              ...
              <li>증빙 문서와 파트너 정보가 연결되어 있는지 보기</li>
              <li>종료 후 어떤 방식으로 결과 보고가 제공되는지 확인하기</li>
            </ul>
          </div>
          <div className="bg-primary text-white rounded-[3rem] p-10">
